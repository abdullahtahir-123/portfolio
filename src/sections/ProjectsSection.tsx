...
function ProjectCard({
  ...
  return (
    <div ref={ref} className="h-[85vh] sticky" style={{ top: '8rem' }}>
      <motion.div
        className="rounded-[40px] sm:rounded-[50px] md:rounded-[60px] border-2 border-[#D7E2EA] bg-[#0C0C0C] p-4 sm:p-6 md:p-8 w-full h-full flex flex-col"
        style={{
          scale,
          top: `${index * 28}px`,
        }}
      >
        ...
        <div className="flex items-start justify-between mb-4 sm:mb-6 md:mb-8">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            <span
              className="text-[#D7E2EA] font-medium uppercase tracking-tight hidden sm:block"
...
export default function ProjectsSection() {
  return (
    <section className="bg-[#0C0C0C] px-5 sm:px-8 md:px-10 pt-10 sm:pt-12 md:pt-14 pb-20 relative z-10 -mt-10 sm:-mt-12 md:-mt-14">
      <FadeIn delay={0} y={40}>
        <h2
